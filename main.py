...
def information():
    ...
    text_pen.print_text((0,640),'PROJECT: The Searching Algorithm',FONT_SIZE=19,mode='bold')
    text_pen.print_text((0,610),'Subject: Fundamentals of Artificial Intelligence')
    text_pen.print_text((0,585),'Implemented by : Zoha,Urooj,Saif')
    text_pen.print_text((0,560),'Lecture:Sir Bilal Ahsan')
    text_pen.print_text((0,535),'Lab instructor: Miss Ramsha Jatt')
